...
// FSK2a timing for HID Prox. Wave counts are derived at runtime from
// LF_FSK2a_PWM_CLOCK with remainder tracking (see fsk2a_wave_count) so longer
// frames (e.g. 36-bit) stay phase-accurate. Local to this .c by design.
